...
export const AssessmentCTASection = () => {
  ...
  return <section id="assessment" className="py-8 lg:py-12 bg-gradient-to-b from-muted/60 to-muted/80">
      <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="text-center mb-16">
              ...
              <p className="text-lg max-w-2xl mx-auto text-muted-foreground">Take our comprehensive RESET assessment and receive a personalized roadmap to elite performance.</p>
            </div>

            {/* Benefits Grid */}
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              {benefits.map((benefit, index) => <div key={index} className="flex flex-col items-center text-center p-6 bg-white rounded-lg border border-lioner-gold/20 hover:border-lioner-gold/40 transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="text-center">
              <Button size="lg" className="bg-white text-lioner-gold hover:bg-lioner-gold hover:text-white hover:border-white font-medium rounded-none px-7 py-3.5 h-auto group text-sm transition-all border-2 border-transparent">
                Take The Assessment
