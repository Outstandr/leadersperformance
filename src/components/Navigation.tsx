        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <Button onClick={openAssessment} className="bg-lioner-gold hover:bg-lioner-gold/90 text-white rounded-none px-6 py-2 text-sm font-medium">
          ...
          {isMobileMenuOpen && (
            <div className="lg:hidden py-4 border-t transition-colors duration-300 border-border/10">
              <div className="flex flex-col space-y-2">
                ...
                <Button onClick={openAssessment} className="mx-4 bg-lioner-gold hover:bg-lioner-gold/90 text-white rounded-none py-3">
                  Take Free Assessment
                </Button>
              </div>
            </div>
