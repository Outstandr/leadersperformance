...
export const HeroSection = () => {
  ...
  return <section id="hero" className={`pt-32 pb-20 transition-colors duration-500 ${isScrolled ? 'bg-foreground' : 'bg-white'}`}>
      <div className="container mx-auto px-4 max-w-7xl">
        <div className={`overflow-hidden p-8 md:p-12 lg:p-16 transition-all duration-500 -ml-4 md:ml-0 ${isScrolled ? 'bg-black border-4 border-[hsl(var(--lioner-gold))]' : 'bg-[hsl(var(--lioner-gold))]'}`}>
          <div className="grid md:grid-cols-[1fr_40%] gap-8 lg:gap-12 items-stretch items-center justify-items-center md:justify-items-start">
            {/* Content */}
            ...
            {/* Image */}
            <div className="relative md:order-2 aspect-[3/4] overflow-hidden shadow-2xl mx-auto md:mx-0">
