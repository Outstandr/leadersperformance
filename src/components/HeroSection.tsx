          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 text-white">
              ...
              <div className="flex items-center gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star key={star} className="w-5 h-5 fill-lioner-gold text-lioner-gold" />
                ))}
                <span className="ml-2 text-sm font-medium">Trusted by Elite Leaders</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Button 
                  size="lg" 
                  className="bg-white text-lioner-blue hover:bg-white/90 font-semibold text-lg px-8 py-6 h-auto rounded-full group"
                >
                ...
                <Button 
                  size="lg" 
                  variant="outline"
                  className="border-2 border-white/30 text-white hover:bg-white/10 font-semibold text-lg px-8 py-6 h-auto rounded-full backdrop-blur-sm"
                >
                  Learn More
                </Button>
              </div>
