          ...
          <div className="overflow-hidden p-8 md:p-12 lg:p-16 bg-[hsl(var(--lioner-gold))]">
            <div className="grid md:grid-cols-1 lg:grid-cols-[1fr_40%] gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-4 md:space-y-6 text-white flex flex-col justify-center items-center md:items-start px-4 md:px-0 text-center md:text-left">
                ...
                {/* Headline */}
                <h1 className="text-4xl md:text-5xl lg:text-5xl font-semibold font-sans leading-tight tracking-tight uppercase">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-4">
                  <Button 
                    size="lg" 
                    asChild
                    className="bg-white text-[hsl(var(--lioner-gold))] hover:bg-[hsl(var(--lioner-gold))] hover:text-white hover:border-white font-bold rounded-none px-7 py-3.5 h-auto group transition-all border-2 border-transparent shadow-lg shadow-black/10 uppercase tracking-wider"
                  >
                  ...
                  <Button 
                    ...
                    className="bg-transparent text-white border-2 border-white hover:bg-white hover:text-[hsl(var(--lioner-gold))] font-bold rounded-none px-7 py-3.5 h-auto group transition-all uppercase tracking-wider"
                  >
                    Audit My Team First
                  </Button>
                </div>
