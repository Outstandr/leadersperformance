...
export const BusinessQuoteSection = () => {
  ...
  return (
    <section
      className="py-16 bg-[hsl(var(--lioner-charcoal))] overflow-hidden relative"
    ...
    >
      ...
      <div className="container mx-auto px-4 max-w-4xl text-center relative z-10">
        ...
        <blockquote className="text-xl md:text-2xl lg:text-3xl font-light text-white leading-relaxed italic">
          ...
          <span className={`transition-colors duration-500 ${isHovered ? "text-lioner-gold" : "text-white"}`}>
        ...
        <div className={`mt-8 transition-all duration-500 ${isHovered ? "opacity-100" : "opacity-70"}`}>
          <div className={`w-12 h-0.5 mx-auto mb-4 transition-all duration-700
            ${isHovered ? "bg-lioner-gold w-20" : "bg-white/20 w-12"}`} />
