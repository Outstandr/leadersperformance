...
const nl: Record<string, string> = {
  ...
  "audit.of": "van",
  "audit.chooseNoBack": "Kies. Geen weg terug.",
  ...
  "audit.q2.optionA": "Chaos. Prestaties dalen. De telefoon rinkelt constant.",
  ...
  "audit.q3.optionA": "Ze bieden excuses aan (\"De markt,\" \"De klant,\" \"Het verkeer\"). We accepteren ze.",
  ...
  "audit.q4.optionA": "Ze dekken voor hem/haar of klagen achter zijn/haar rug.",
  "audit.q4.optionB": "Ze corrigeren hem/haar. Het team eist de norm vóórdat ik dat doe.",
  "audit.q5.title": "DE VERGADERINGSBELASTING",
  "audit.q5.question": "Hebben jouw vergaderingen een duidelijke agenda en een vaste eindtijd?",
  "audit.q5.optionA": "Nee. We praten totdat we ons 'klaar' voelen. Het sleept vaak.",
  "audit.q5.optionB": "Ja. Duidelijk doel. Vaste stop. Als je te laat bent, is de deur gesloten.",
  "audit.q6.title": "DE PROBLEEMOPLOSSER",
  "audit.q6.question": "Wanneer er een probleem ontstaat, wat belandt er op jouw bureau?",
  ...
  "audit.q7.question": "Wees eerlijk. Als je vandaag je hele huidige team opnieuw zou aannemen, doe je dat?",
